...
class ner_logic:
    ...
    def build(self, inp):
        ...
        if match_find_cities_andra_pradesh or match_find_town_andra_pradesh or match_find_village_andra_pradesh or match_find_states or match_find_cities_Arunachal_Pradesh or match_find_villages_or_town_Arunachal_Pradesh or match_find_cities or matches_offensive_words:
